...
fn main() {
    ...
    let builder = bindgen::builder()
        ...
        .allowlist_type("spa_.*")
        .allowlist_var("SPA_.*")
        .blocklist_var("SPA_TIME_INVALID")
        .blocklist_var("SPA_IDX_INVALID")
        .blocklist_var("SPA_ID_INVALID")
        ...
        .raw_line("pub const SPA_TIME_INVALID: i64 = i64::MIN;")
        .raw_line("pub const SPA_IDX_INVALID: u32 = u32::MAX;")
        .raw_line("pub const SPA_ID_INVALID: u32 = u32::MAX;")
