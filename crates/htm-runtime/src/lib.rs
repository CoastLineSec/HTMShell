...
pub use component::{
    ...
    ComponentReference, ComponentResourceKindSet, ComponentResourceReferenceValue,
    ComponentSlotDeclaration, ComponentSlotDefinition, ComponentSlotDefinitionId,
    ComponentSlotName, ComponentSlotProjectionId, ComponentSlotProjectionOutcome,
    ComponentSlotProjectionRecord, ComponentSlotProjectionVersion, ComponentValidationTotals,
    ...
    MAX_COMPONENT_SOURCE_NODES, MAX_RESOURCE_REFERENCE_VALUES_PER_PREPARED_ROOT, PreparedDocument,
...
pub use component_resource::{
    ...
    MAX_COMPONENT_SVG_SOURCE_BYTES, MAX_COMPONENT_SVG_WIDTH, ResourceOriginAssociation,
    SurfaceResourceAssociation, SurfaceResourceOwner,
};
