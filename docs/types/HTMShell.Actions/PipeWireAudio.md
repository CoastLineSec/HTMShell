...
Requests are generation-safe, coalesced per node, and confirmed by reported PipeWire parameters. Permission denial, timeout, target removal, or reconnect cannot update a stale control.
